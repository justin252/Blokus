...
val corners_of_player_piece: bool array array->(int*int) list

val check_i_zero: int -> bool array array-> (int*int) list

val check_j_zero: int -> bool array array-> (int*int) list

val check_any: int -> int -> bool array array-> (int*int) list
